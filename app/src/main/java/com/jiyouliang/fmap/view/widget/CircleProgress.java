...
import com.jiyouliang.fmap.BuildConfig;
import com.jiyouliang.fmap.R;
import com.jiyouliang.fmap.util.Constants;
import com.jiyouliang.fmap.util.MiscUtil;
...
public class CircleProgress extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        antiAlias = typedArray.getBoolean(R.styleable.CircleProgressBar_antiAlias, Constants.ANTI_ALIAS);
        ...
        mHintSize = typedArray.getDimension(R.styleable.CircleProgressBar_hintSize, Constants.DEFAULT_HINT_SIZE);

        mValue = typedArray.getFloat(R.styleable.CircleProgressBar_value, Constants.DEFAULT_VALUE);
        mMaxValue = typedArray.getFloat(R.styleable.CircleProgressBar_maxValue, Constants.DEFAULT_MAX_VALUE);
        //内容数值精度格式
        ...
        mValueSize = typedArray.getDimension(R.styleable.CircleProgressBar_valueSize, Constants.DEFAULT_VALUE_SIZE);
        ...
        mUnitSize = typedArray.getDimension(R.styleable.CircleProgressBar_unitSize, Constants.DEFAULT_UNIT_SIZE);

        mArcWidth = typedArray.getDimension(R.styleable.CircleProgressBar_arcWidth, Constants.DEFAULT_ARC_WIDTH);
        mStartAngle = typedArray.getFloat(R.styleable.CircleProgressBar_startAngle, Constants.DEFAULT_START_ANGLE);
        mSweepAngle = typedArray.getFloat(R.styleable.CircleProgressBar_sweepAngle, Constants.DEFAULT_SWEEP_ANGLE);

        mBgArcColor = typedArray.getColor(R.styleable.CircleProgressBar_bgArcColor, Color.WHITE);
        mBgArcWidth = typedArray.getDimension(R.styleable.CircleProgressBar_bgArcWidth, Constants.DEFAULT_ARC_WIDTH);
        ...
        mAnimTime = typedArray.getInt(R.styleable.CircleProgressBar_animTime, Constants.DEFAULT_ANIM_TIME);
